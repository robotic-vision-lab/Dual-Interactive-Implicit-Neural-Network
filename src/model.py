...
class Mark_1(nn.Module):
    ...
    def forward(self, x, p):
        ...
        features_0 = F.grid_sample(x, p, mode='bilinear', align_corners=False) #features_0(N,C0,H',W')
        ...
        x = self.conv4(x)
        features_4 = F.grid_sample(x, p, mode='bilinear', align_corners=False) #features_4(N,C4,H',W')
